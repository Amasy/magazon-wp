...
<?php if ( have_comments() ) : ?><!--you need the id comments for the links to the comments-->
    	<h4 class="comments-header-title"><?php comments_number(__('No Responses','magazon'), __('One Response','magazon'), __('% Responses','newstock') );?> to &#8220;<?php the_title(); ?>&#8221;</h4>
...
<?php else : // this is displayed if there are no comments so far ?>
	...
	<?php if ('open' == $post->comment_status) : ?>
        ...
        <p class="meta" id="comments">
            <?php comments_number(__('No Responses','newstock'), __('One Response','magazon'), __('% Responses','magazon') );?> 
