...
function st_page_template(){
    ...
    if(is_singular()){
       ...
       if(!empty($file) && file_exists(ST_TEMPLATE_DIR.$file.'.php')){
...
*/
function st_make_font_style($font,$css_selector,$show_font_size= false){
    if($font['font-family']!=''){
    $is_not_gfont = key_exists($font['font-family'],st_get_normal_fonts()); 
?>
<?php if(!$is_not_gfont) : ?>
<link href='http://fonts.googleapis.com/css?family=<?php echo  rawurlencode($font['font-family']); ?>' rel='stylesheet' type='text/css'>
<?php endif; ?>
<style type="text/css">
<?php echo $css_selector; ?>{  font-family: '<?php echo $font['font-family']; ?>'; <?php if($font['font-style']): ?>font-style: <?php echo $font['font-style']; ?>; <?php endif; ?> <?php if($font['font-style']): ?> font-style: <?php echo $font['font-style']; ?>;<?php endif; ?> <?php if($font['font-weight']): ?> font-weight: <?php echo $font['font-weight']; ?>; <?php endif; ?> }
</style>
<?php
    /*
    <?php if($font['font-size']): ?>
    font-size: <?php echo intval($font['font-size']); ?>px;
    <?php endif; ?>
    <?php if($font['line-height']): ?>
...
function st_theme_font(){
    ...
    <style type="text/css">
      /************** Predefined Colors ********************/
        .primary-nav ul li a:hover,.primary-nav ul li.current-menu-item > a,.primary-nav ul li a:hover,.primary-nav ul li.current-menu-item > a,.carousel-post-meta,.read-more-button,.list-tabbed li.list-tabbed-active a,table#wp-calendar thead > tr > th,table#wp-calendar td#today,.carousel-wrapper .flex-direction-nav .flex-prev:hover,.carousel-wrapper .flex-direction-nav .flex-next:hover,.subs_submit:hover,.tagcloud a:hover,.author-text b,#submit,.page-tags a:hover,.categories a,.thumb-slider-wrapper .flex-direction-nav .flex-next:hover,.thumb-slider-wrapper .flex-direction-nav .flex-prev:hover,.review-score-over, .review-total-score-wrapper .right,.inside-post-slider .flex-direction-nav .flex-next:hover,.inside-post-slider .flex-direction-nav .flex-prev:hover,.inside-post-slider .flex-control-nav li a.flex-active,.inside-post-slider .flex-control-nav li a:hover,.btn.color,.btn:hover,.tab-title li.current,.acc-title-active,.acc-title:hover,.toggle-title:hover,.toggle_current,.st-pagination .page-current,.st-pagination li a:hover,.carousel-next:hover,.carousel-prev:hover,.content input[type=submit]{background-color: #<?php echo $skin ?>;-webkit-transition: all .2s linear;-moz-transition: all .2s linear;-o-transition: all .2s linear;transition: all .2s linear;}.footer-wrapper li.widget-post-wrapper:hover .widget-post-thumb img,.flickr_badge_image a img:hover{border: 1px solid #<?php echo $skin; ?>;-webkit-transition: all .2s linear;-moz-transition: all .2s linear;-o-transition: all .2s linear;transition: all .2s linear;
    }
    </style>
    <?php
}
...
add_action('wp_head','st_theme_bg_head',99);
