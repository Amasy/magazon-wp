...
include('page-builder-functions.php');
include('page-builder-generate-code.php');
...
function st_builder_js(){
    global $ajax_nonce;
     wp_localize_script('jquery','STpb_options',array(
...
function st_page_builder_box($options= array()){
    ...
    $builder_items = get_page_builder_items();
       ...
       <?php  if('post'!= strtolower($post->post_type)):  ?>
